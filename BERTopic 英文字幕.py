...
def train_topic_model(df_new, output_dir,min_cluster_size=10, use_saved_embeddings=0, topic_n_words=15, nr_topics='auto'):
    ...
    # 聚类
    hdbscan_model = HDBSCAN(min_cluster_size=min_cluster_size, metric='euclidean', cluster_selection_method='leaf',
...
if __name__ == "__main__":
    ...
    input_file = './China/cleaned_subtitle.csv'
    output_dir = './输出文件/China/subtitle'
    ...
    train_topic_model(df_new, output_dir, 10, 1, 20, 50)